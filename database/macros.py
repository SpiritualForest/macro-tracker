...
data = {
        ...
        "Freshona sweetcorn": Macros(Calories=82, Fat=2.5, Carbs=11, Fiber=2.7, Protein=2.5, Water=75.95, Sodium=300),
        "Freshona peas": Macros(Calories=87, Fat=1.1, Carbs=5.3, Fiber=0, Protein=9.2, Water=0, Sodium=460),
        "Freshona tomato puree": Macros(Calories=98, Fat=0.4, Carbs=15.6, Fiber=0, Protein=4.6, Water=0, Sodium=1000),
        # Salt, sugar
